    ...
    def _generate_terrain(self, hardcore):
        ...
        for i in range(TERRAIN_LENGTH):
            ...
            if state==GRASS and not oneshot:
                ...
                #-----------------------------------------------
                ##counter = self.np_random.randint(3, 5)  # 3,4  original
                #counter = self.np_random.randint(2,3)  #  short ?
                #counter = 2  # ゲームが停止しない
                counter = 3
                poly = [
                    (x,              y),
            ...
            if counter==0:
                ...
                if state==GRASS and hardcore:
                    ...
                    state = 1 # only 切り株　凸
                    #state = 2 # only  STAIRS　階段
                    #state = 3 # only PIT (落とし穴）
                    ####-------------------------------------------------------
                    oneshot = True
                else:
                    state = GRASS
